...
def setup_document_share(ftl_doc, expire_at=None, password=None, note=tv.DOCUMENT_SHARING_LINK_1_NOTE):
    return FTLDocumentSharing.objects.create(ftl_doc=ftl_doc, expire_at=expire_at, password=password, note=note)
