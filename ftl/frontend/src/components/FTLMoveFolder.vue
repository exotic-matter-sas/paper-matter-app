  ...
  <b-modal :id="modalId" scrollable>
    ...
    <b-container fluid>
      <b-row>
        <b-col>
          <FTLTreeFolders
            :folder-to-disable="folder.parent"
    ...
    moveFolder: function () {
      if (this.folder.parent === this.selectedMoveTargetFolder.id) {
        this.mixinAlertWarning(
          this.$t("Selected folder is already located in this folder.")
        );
      } else {
        let body = {
