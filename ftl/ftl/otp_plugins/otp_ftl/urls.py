...
urlpatterns = [
    ...
    path('static/<str:pk>/update', views_static.StaticDeviceUpdate.as_view(), name='otp_static_update'),
    ...
    path('totp/<str:pk>/update', views_totp.TOTPDeviceUpdate.as_view(), name='otp_totp_update'),
    ...
    path('fido2/<str:pk>/update', views_fido2.Fido2DeviceUpdate.as_view(), name='otp_fido2_update'),
