...
urlpatterns = [
    ...
    path('static/<str:pk>', views_static.StaticDeviceDelete.as_view(), name='otp_static_delete'),
    ...
    path('totp/<str:pk>', views_totp.TOTPDeviceDelete.as_view(), name='otp_totp_delete'),
