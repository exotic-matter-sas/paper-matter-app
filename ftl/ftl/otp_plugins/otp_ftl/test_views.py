...
from ftests.test_account import TotpDevice2FATests, totp_time_property, totp_time_setter, mocked_totp_time_setter
...
class TwoFaCheckPagesTests(TestCase):
    ...
    def setUp(self):
        ...
        self.totp_device = setup_2fa_totp_device(self.user, secret_key=TotpDevice2FATests.secret_key)
    ...
    def test_session_timeout_reduced_during_2fa_check(self):
        ...
        cookie_expiration_time = datetime.strptime(cookie_expiration_time, "%a, %d %b %Y %H:%M:%S GMT")
        cookie_expiration_time = django_timezone.make_aware(cookie_expiration_time, timezone.utc)
